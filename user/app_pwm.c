...
static void Motor_L_Init(void)
{
	...
	TIM_TimeBaseInitStruct.TIM_Period = 999;//自动重装载
	TIM_TimeBaseInitStruct.TIM_Prescaler = 0;//分频数
	TIM_TimeBaseInitStruct.TIM_RepetitionCounter = 0;//重计数
	...
	TIM_OCInitStruct.TIM_OCMode = TIM_OCMode_PWM1;//输出比较的工作模式PWM1模式
	TIM_OCInitStruct.TIM_OCPolarity = TIM_OCPolarity_High;//极性
	TIM_OCInitStruct.TIM_OutputState = ENABLE;//输出使能
	TIM_OCInitStruct.TIM_Pulse = 0;//CCRx初始值
